"""Weather Agent - FMAPI-powered agent loop with MCP tool calling."""
...
async def run_task(task_description: str) -> dict:
    ...
    Args:
        task_description: Natural language description of what weather info to gather
    ...
    try:
        ...
        logger.error(f"Failed to connect to Weather MCP: {e}")
        return {"status": "error", "result": f"Failed to connect to Weather MCP server: {e}", "tools_called": []}
